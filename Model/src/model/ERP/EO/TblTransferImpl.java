...
public class TblTransferImpl extends EntityImpl {
    ...
    public static final int FRPROJECTID = AttributesEnum.FrProjectId.index();
    ...
    /**
     * Gets the attribute value for FrProjectId, using the alias name FrProjectId.
     * @return the value of FrProjectId
     */
    public BigDecimal getFrProjectId() {
        return (BigDecimal) getAttributeInternal(FRPROJECTID);
    }

    /**
     * Sets <code>value</code> as the attribute value for FrProjectId.
     * @param value value to set the FrProjectId
     */
    public void setFrProjectId(BigDecimal value) {
        setAttributeInternal(FRPROJECTID, value);
    }
